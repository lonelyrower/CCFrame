    ...
    <div className="min-h-[100dvh] bg-stone-50 dark:bg-neutral-950 py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          ...
          <EmptyState
            title="暂无系列"
            description={<>还没有创建任何系列，可以将相关照片组织成主题系列</>}
            icon={
            ...
            {seriesList.map((series, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] bg-stone-200 dark:bg-neutral-800 overflow-hidden">
                  {series.coverPhoto ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-stone-200 to-stone-300 dark:from-neutral-800 dark:to-neutral-900">
                      <svg
                        className="w-20 h-20 text-[color:var(--ds-muted-soft)]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={1}
                ...
                <div className="p-8">
                  ...
                  {series.summary && (
                    <p className="font-sans text-base leading-relaxed text-[color:var(--ds-muted)] mb-6 line-clamp-2">
                      {series.summary}
                    </p>
                  )}
                  <div className="flex items-center gap-4 text-sm font-sans text-[color:var(--ds-muted-soft)]">
