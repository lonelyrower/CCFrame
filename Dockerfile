...
# Prisma CLI pulls in `@prisma/config`, which imports `effect`'s FastCheck module.
# These deps are not included in Next.js standalone output, but are required to run
# `prisma migrate` inside this container.
